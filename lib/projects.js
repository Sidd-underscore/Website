...
import lightshows_snapshot_lasers from "@/public/images/projects/lightshows/snapshots/LASERS.jpg";
        ...
        >
          ...
          <ol>
            ...
            <li>
              ...
              <Image
                src="/images/projects/2025-amelie-projections/flyers-2.png"
          ...
          <p>
            ...
            them to the computers. Thankfully, my good friend{" "}
          ...
          <p>
            ...
            laser projector mounted on the balcony to hit the entire set, and a
            smaller 8 000 lumen projector focused purely on backwards projection
            for the center window. We spent many, many days trying to mount
            projectors in various configurations (on the balcony rail? not
            enough room! in the spot booth? not enough range! on stage? too many
            shadows! in the walkway? fire hazard!), but eventually we simply
            placed it in the balcony seating itself and blocked out the area
            around it. Unfortunately, this meant that we had to move the
            projector when another group needed to use the balcony, but it was
            the only way to get it to work nicely.
          </p>
          ...
          <p>
            ...
            video editing, animation, collaboration, QLab, and the horrors of giant projectors.
            I am so thankful to my tech theatre director for giving me this
            opportunity, and the entire cast & amazing crew for doing this show
            with me!!!
          </p>
        </div>
      </>
...
export const lightshows = [
  ...
  />,
  <ProductImage
    src={{ dark: lightshows_snapshot_lasers }}
    alt="lightshows_snapshot_lasers"
    key="lightshows_snapshot_lasers"
    className="aspect-video h-full w-full"
  />,
  <ProductImage
