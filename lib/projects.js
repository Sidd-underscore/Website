...
import lightshows_snapshots_better_1 from "@/public/images/projects/lightshows/snapshots/better-1.jpg";
import lightshows_snapshots_better_6 from "@/public/images/projects/lightshows/snapshots/better-6.jpg";
import lightshows_snapshots_behind from "@/public/images/projects/lightshows/snapshots/behind.jpg";
import lightshows_snapshots_blue from "@/public/images/projects/lightshows/snapshots/blue.jpg";
import lightshows_snapshots_pinkkkk from "@/public/images/projects/lightshows/snapshots/pinkkkk.png";
import lightshows_snapshots_wowwww from "@/public/images/projects/lightshows/snapshots/wowwww.jpg";
...
import prep_checklist_dark from "@/public/images/projects/prep/prep-checklist-dark.png";
import prep_checklist_light from "@/public/images/projects/prep/prep-checklist-light.png";
import prep_emergency_dialog_dark from "@/public/images/projects/prep/prep-emergency-dialog-dark.png";
import prep_emergency_dialog_light from "@/public/images/projects/prep/prep-emergency-dialog-light.png";
import prep_full_map_dark from "@/public/images/projects/prep/prep-full-map-dark.png";
import prep_full_map_light from "@/public/images/projects/prep/prep-full-map-light.png";
import prep_main_page_dark from "@/public/images/projects/prep/prep-main-page-dark.png";
import prep_main_page_light from "@/public/images/projects/prep/prep-main-page-light.png";
      ...
      <>
        ...
        >
          ...
          <p>
            ...
            Northwest, my colleague Brian Wei and I created PREP so anyone,
            anytime, on any device can access critical emergency warnings, nearby
            shelters and hospitals, and other preparedness information at the
            moment they might need it most Because it&apos;s a web application,
            there is no need to download anything. Users simply open it in a
            browser from a phone, tablet, or laptop and are ready to go. This
            means accessibility from anywhere.
          </p>
          ...
          <PhotoGallery
            photos={[
              <ProductImage
                ...
                key="prep_main_page"
                src={{
                  dark: prep_main_page_dark,
                  light: prep_main_page_light,
                }}
              />,
              <ProductImage
                size="large"
                key="prep_full_map"
                src={{ dark: prep_full_map_dark, light: prep_full_map_light }}
              />,
              <ProductImage
                size="large"
                key="prep_checklist"
                src={{
                  dark: prep_checklist_dark,
                  light: prep_checklist_light,
                }}
              />,
              <ProductImage
                size="large"
                ...
                src={{
                  dark: prep_emergency_dialog_dark,
                  light: prep_emergency_dialog_light,
                }}
              />,
            ]}
          />
        ...
        <div className="mb-4 w-full space-x-4">
          <PhotoGallery
            photos={[
              <ProductImage
                key="resolved_hero"
                src={{ dark: resolved_hero }}
              />,
              <ProductImage
                key="resolved_product"
                src={{ dark: resolved_product }}
              />,
              <ProductImage
                key="resolved_reviews"
                src={{ dark: resolved_reviews }}
              />,
              <ProductImage
                key="resolved_suggested_products"
                src={{ dark: resolved_suggested_products }}
              />,
            ]}
          />
...
export const lightshows = [
  ...
  />,
  <ProductImage
    alt="lightshows_snapshots_behind"
    key="lightshows_snapshots_behind"
    src={{ dark: lightshows_snapshots_behind }}
    className="aspect-video h-full w-full"
  />,
  <ProductImage
    alt="lightshows_snapshots_blue"
    key="lightshows_snapshots_blue"
    src={{ dark: lightshows_snapshots_blue }}
    className="aspect-video h-full w-full"
  />,
  <ProductImage
    alt="lightshows_snapshots_pinkkkk"
    key="lightshows_snapshots_pinkkkk"
    src={{ dark: lightshows_snapshots_pinkkkk }}
    className="aspect-video h-full w-full"
  />,
  <ProductImage
    alt="lightshows_snapshots_wowwww"
    key="lightshows_snapshots_wowwww"
    src={{ dark: lightshows_snapshots_wowwww }}
    className="aspect-video h-full w-full"
  />,
  <ProductImage
    alt="lightshows_snapshots_better_1"
    key="lightshows_snapshots_better_1"
    src={{ dark: lightshows_snapshots_better_1 }}
    className="aspect-video h-full w-full"
  />,
  <iframe
    key="Martin Garrix, Arijit Singh - Angels For Each Other | Lightshow"
    className="aspect-video h-full w-full rounded-lg border-2 border-neutral-200 dark:border-neutral-800"
  ...
  />,
  <ProductImage
    alt="lightshows_snapshots_better_6"
    key="lightshows_snapshots_better_6"
    src={{ dark: lightshows_snapshots_better_6 }}
    className="aspect-video h-full w-full"
  />,
  <ProductImage
  ...
  />,
  <iframe
    key="Chase &amp; Status, Bou - Baddadan (Henry Fong Remix) | Lightshow"
    className="aspect-video h-full w-full rounded-lg border-2 border-neutral-200 dark:border-neutral-800"
  ...
  />,
  <iframe
    key="KSHMR - The Spook (Returns) | Lightshow"
    className="aspect-video h-full w-full rounded-lg border-2 border-neutral-200 dark:border-neutral-800"
    src="https://www.youtube.com/embed/E8QyNwXD09g"
    title="HSMR - The Spook (Returns) | Lightshow"
    frameBorder="0"
    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
    referrerPolicy="strict-origin-when-cross-origin"
    allowFullScreen
