...
export const lightshows = [
  ...
  />,
  <ProductImage
    src={lightshows_snapshot_purple_pink}
  ...
  <ProductImage
    ...
    src={lightshows_snapshot_movement_is_going_good}
    className="aspect-video h-full w-full"
  />,
  <iframe
