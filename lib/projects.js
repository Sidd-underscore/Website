...
import purai_homepage_light from "@/public/images/projects/purai/purai-homepage-light.png";
import purai_homepage_dark from "@/public/images/projects/purai/purai-homepage-dark.png";
import purai_chat_completions_light from "@/public/images/projects/purai/purai-chat-completions-light.png";
import purai_chat_completions_dark from "@/public/images/projects/purai/purai-chat-completions-dark.png";
import purai_python_initializing_light from "@/public/images/projects/purai/purai-python-initializing-light.png";
import purai_python_initializing_dark from "@/public/images/projects/purai/purai-python-initializing-dark.png";
import purai_features_light from "@/public/images/projects/purai/purai-features-light.png";
import purai_features_dark from "@/public/images/projects/purai/purai-features-dark.png";
import purai_audio_footer_light from "@/public/images/projects/purai/purai-audio-footer-light.png";
import purai_audio_footer_dark from "@/public/images/projects/purai/purai-audio-footer-dark.png";
import purai_flexible_usage_light from "@/public/images/projects/purai/purai-flexible-usage-light.png";
import purai_flexible_usage_dark from "@/public/images/projects/purai/purai-flexible-usage-dark.png";
import purai_error_reference_light from "@/public/images/projects/purai/purai-error-reference-light.png";
import purai_error_reference_dark from "@/public/images/projects/purai/purai-error-reference-dark.png";
import purai_model_list_light from "@/public/images/projects/purai/purai-model-list-light.png";
import purai_model_list_dark from "@/public/images/projects/purai/purai-model-list-dark.png";
...
import resolved_product_detail from "@/public/images/projects/resolved/product-detail.png";
import resolved_whats_included from "@/public/images/projects/resolved/whats-included.png";
import resolved_reviews from "@/public/images/projects/resolved/reviews.png";
import resolved_all_products from "@/public/images/projects/resolved/all-products.png";
import resolved_tutorials from "@/public/images/projects/resolved/tutorials.png";
...
export const projects = [
    ...
    longDescription: (
      <>
        <div
          ...
          style={{ maxWidth: "none" }}
        >
          <p className="checker-surface p-2 border-2 text-lg font-medium flex items-center space-x-2">
            <Trophy/> <strong>Honorable Mention</strong><span>in the 2025 Congressional App
            Challenge, Oregon&apos;s First Congressional District.</span>
      ...
      <>
        ...
        <div className="mb-4 w-full space-x-4">
          <PhotoGallery
            photos={[
              ...
              <ProductImage
                size="large"
                key="resolved_product_detail"
                src={resolved_product_detail}
              />,
              <ProductImage
                size="large"
                key="resolved_whats_included"
                src={resolved_whats_included}
              />,
              <ProductImage
                size="large"
                key="resolved_reviews"
                src={resolved_reviews}
              />,
              <ProductImage
                size="large"
                key="resolved_all_products"
                src={resolved_all_products}
              />,
              <ProductImage
                size="large"
                key="resolved_tutorials"
                src={resolved_tutorials}
              />,
            ]}
          />
        ...
        >
          ...
          <p>
            ...
            in dozens of countries processing thousands of dollars in transactions per month, and I am incredibly proud of the work we have done.
          </p>
        </div>
      </>
    ),
  ...
  },
  {
    ...
    id: "pur-ai",
    description:
      "I designed a documentation-first website for PurAI with a polished visual system, strong hierarchy, and a more distinctive brand presence.",
    technologies: [
      technologyInformation.tailwindcss,
      technologyInformation.nextjs,
    ],
    ...
    longDescription: (
      ...
      >
        ...
        <p>
          PurAI was designed as a documentation-first product experience: clear
          navigation, predictable content hierarchy, and a layout that made
          technical information feel approachable without losing precision. I
          wanted it to feel calm and refined, with subtle cues inspired by
          Apple&apos;s attention to spacing, typography, and restraint, while
          still keeping a strong visual identity of its own.
        </p>

        <p>
          The system leans on soft depth, rounded surfaces, and careful contrast
          so the interface stays readable in both light and dark modes. I also
          paid close attention to the smaller details that make a docs site feel
          credible: consistent code presentation, clear sectioning, and a simple
          presentation style to present information clearly.
        </p>
        ...
        <div className="w-full space-x-4">
          <PhotoGallery
            photos={[
              <ProductImage size="large" key="purai_homepage_light" src={purai_homepage_light} />,
              <ProductImage size="large" key="purai_homepage_dark" src={purai_homepage_dark} />,
              <ProductImage size="large" key="purai_chat_completions_light" src={purai_chat_completions_light} />,
              <ProductImage size="large" key="purai_chat_completions_dark" src={purai_chat_completions_dark} />,
              <ProductImage size="large" key="purai_python_initializing_light" src={purai_python_initializing_light} />,
              <ProductImage size="large" key="purai_python_initializing_dark" src={purai_python_initializing_dark} />,
              <ProductImage size="large" key="purai_features_light" src={purai_features_light} />,
              <ProductImage size="large" key="purai_features_dark" src={purai_features_dark} />,
              <ProductImage size="large" key="purai_audio_footer_light" src={purai_audio_footer_light} />,
              <ProductImage size="large" key="purai_audio_footer_dark" src={purai_audio_footer_dark} />,
              <ProductImage size="large" key="purai_flexible_usage_light" src={purai_flexible_usage_light} />,
              <ProductImage size="large" key="purai_flexible_usage_dark" src={purai_flexible_usage_dark} />,
              <ProductImage size="large" key="purai_error_reference_light" src={purai_error_reference_light} />,
              <ProductImage size="large" key="purai_error_reference_dark" src={purai_error_reference_dark} />,
              <ProductImage size="large" key="purai_model_list_light" src={purai_model_list_light} />,
              <ProductImage size="large" key="purai_model_list_dark" src={purai_model_list_dark} />,
            ]}
          />
        </div>
      </div>
    ),
    featuredImage: purai_homepage_light,
  },
  {
    name: "cobalt-ext",
    id: "cobalt-ext",
