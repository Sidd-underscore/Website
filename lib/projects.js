...
export const projects = [
      ...
      <>
        ...
        <div className="w-full space-x-4">
          <PhotoGallery
            scroll={1096}
            photos={[
              <ProductImage src={purai_splash} />,
              <ProductImage src={purai_docs_1} />,
              <ProductImage src={purai_docs_2} />,
              <ProductImage src={purai_docs_3} />,
              <ProductImage src={purai_showcase_1} />,
              <ProductImage src={purai_showcase_2} />,
              <ProductImage src={purai_pricing} />,
            ]}
          />
        </div>
      </>
  ...
  },
  {
    ...
    longDescription: (
      <div className="prose prose-neutral dark:prose-invert" style={{maxWidth: "none"}}>
