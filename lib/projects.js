...
export const technologyInformation = {
  ...
  qlab: {
    name: "QLab",
    icon: <QLabLogo className="w-[1.5em] rounded-full" alt="" />,
  },
};
...
export const projects = [
  {
    ...
    longDescription: (
      <>
        ...
        >
          <p>
            This was probably the most complicated project I&#39;d ever taken
            charge of.{" "}
          </p>
          <p>
          ...
          <p>
            ...
            from the placement of the projectors, to the computers crashing, to the
            projectors disconnecting mid show... It was a ton of trial and error
            to try and make this happen. The most stressful example of this was
            when, on the day of opening, we had to buy a new computer (to
            hopefully stop some rendering issues) and I had to spend 4 hours
            redoing all of my surface maps on QLab right before the show.{" "}
          </p>
          <p>
            There are countless more example of setbacks I could yap all day
            about, but, at the end of the day, the shows happened and I learned
            the most things I have ever learned in a project before. I am
            eternally grateful to my tech theatre director for presenting me
            with such a valuable hands-on opportunity, and oh my god I hate
            projectors.
          </p>
        </div>
      </>
