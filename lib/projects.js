...
export const lightshows = [
  <iframe
    key="Rise  - DJ Isaac  |  A New Type of Lightshow"
  ...
  />,
  <iframe
    key="Baddadan  - Chase &amp; Status, Bou (Henry Fong Remix) | A New Type of Lightshow"
    className="aspect-video h-full w-full rounded-lg border-2 border-neutral-200 dark:border-neutral-800"
  ...
  />,
  <iframe
    key="KSHMR - The Spook (Returns) | A New Type of Lightshow"
    className="aspect-video h-full w-full rounded-lg border-2 border-neutral-200 dark:border-neutral-800"
    src="https://www.youtube.com/embed/E8QyNwXD09g"
    title="KSHMR - The Spook (Returns) | A New Type of Lightshow"
    frameBorder="0"
    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
    referrerPolicy="strict-origin-when-cross-origin"
    allowFullScreen
  ...
  />,
  <ProductImage
    src={lightshows_snapshot_lasers}
