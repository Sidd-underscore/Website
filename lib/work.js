    ...
    description: (
      <div className="space-y-4">
        <p>
          ...
          (2024) (lots of fun stories about building rolling rooms, but
          that&apos;s for another time 😅). I then used those building skills to
          design and build to set for our play festival, &quot;Fresh Ink&quot; (2025). For
          &quot;Amélie&quot; (2025), I not only helped build the set but also established
          and managed the projections department. This was the first time my
          school had ever attempted to use projections in a show, so I had to
          start from scratch and learn everything myself! Beyond school
          productions, I help Portland Panto Players as Second Sound Engineer
          for &quot;Sleeping Beauty&quot; (2024), and completed an internship at Broadway
          Rose Theatre as a spotlight operator for &quot;The Jungle Book&quot; (2024).
        </p>
