export const work = [
  {
    ...
    details: [
      "Livestream church events to YouTube using OBS and YouTube Studio, as well as PTZ Optics for the cameras",
      "Run A/V equipment and tech when needed at both mass and church events",
    ],
    description: (
  ...
  },
  {
    ...
    details: [
      ...
      'Set builder and stagehand for Lincoln High School\'s "Clue: On Stage" (2025)',
      'Set designer and builder for Lincoln High School\'s "Fresh Ink" (2025)',
      'Set builder and established/ran a projections department for Lincoln High School\'s "Amélie" (2025)',
    ],
    decorations: [
    ...
    description: (
      <div className="space-y-4">
        <p>
          I've been working in technical theatre since 2023 in various roles. At
          my High School, Lincoln High School, I operated spotlights for the
          76th & 77th annual Talent Show (2024 & 2025) and later learned and
          started leading set building for productions like "Clue: On Stage"
          (2024) (lots of fun stories about building rolling rooms, but that's
          for another time 😅). I then used those building skills to design and
          build to set for our play festival, "Fresh Ink" (2025). For "Amélie"
          (2025), I not only helped build the set but also established and
          managed the projections department. This was the first time my school
          had ever attempted to use projections in a show, so I had to start
          from scratch and learn everything myself! Beyond school productions, I
          help Portland Panto Players as Second Sound Engineer for "Sleeping
          Beauty" (2024), and completed an internship at Broadway Rose Theatre
          as a spotlight operator for "The Jungle Book" (2024).
        </p>
