    ...
    <>
      ...
      >
        ...
        <motion.div className="flex">
          ...
          <div className="-mt-6 ml-26 h-fit bg-neutral-50 sm:-mt-6 sm:ml-34 ">
            <MakitaLogo className="size-12 text-black opacity-50 invert-0 sm:size-13 md:size-14  " />
          </div>
          <div className="mt-56 ml-20 h-fit bg-neutral-50 sm:mt-64 sm:ml-28 ">
            <SoundcraftLogo className="size-16 fill-black opacity-75 sm:size-17 md:size-18 " />
          </div>
        </motion.div>
      </motion.div>
      <motion.div
      ...
      >
        <motion.div className="flex">
          ...
          <div className="mt-60 ml-[5rem] h-fit rounded-full bg-neutral-50 sm:mt-[16.5rem] sm:ml-[5.5rem] ">
            <ETCLogo className="size-14 fill-black opacity-75 " />
          </div>
          <div className="mt-[3.5rem] ml-14 h-fit bg-neutral-50 ">
            <AudixLogo className="size-14 fill-neutral-950 stroke-neutral-950 text-black opacity-75   " />
          </div>
        </motion.div>
      </motion.div>
      ...
      <motion.div
        style={{ display, opacity, position }}
        className="top-[50%] left-[50%] h-[10rem] w-[10rem] translate-x-[-50%] translate-y-[-50%] rounded-full border border-pink-300 select-none sm:h-[12rem] sm:w-[12rem] "
      />
    </>
  );
}
