...
export function FeaturedPhotos() {
  ...
  useEffect(() => {
    ...
    trueResult.push(
      <Link
        href="/photos"
        className="flex h-96 min-w-[289.13px] items-center justify-center rounded-lg bg-gradient-to-br border-none from-neutral-100 via-pink-100 to-neutral-100 dark:from-neutral-900 dark:via-pink-500/15 dark:to-neutral-900"
      >
