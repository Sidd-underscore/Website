...
export function Navbar() {
  return (
    <div className="fixed left-0 top-0 z-10 flex w-screen items-center justify-center xl:top-4 ">
      <div className="fixed h-[14rem] w-screen bg-gradient-to-b from-neutral-50 via-neutral-50 to-transparent dark:h-[16rem] dark:from-neutral-950 dark:via-neutral-950" />
